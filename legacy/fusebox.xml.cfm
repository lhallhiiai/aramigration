...
<fusebox xmlns:test="test">
	...
	<circuits>
		...
		<circuit alias="script" path="model/scripts/" parent="" />
		<circuit alias="users" path="model/m_user/" parent="" />
		<circuit alias="emails" path="model/m_emails/" parent="" />
		<circuit alias="m_forms" path="model/m_forms/" parent="" />
		<circuit alias="m_ara" path="model/m_ara/" parent="" />
