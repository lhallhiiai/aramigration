...
<cfset subject="ARA #reference# Early Start Complete: CLINS Added">
<!--- Pull Up CLINs for EMail Message --->
<cfquery name="getClins" datasource="#application.dsn#">
	Select ClinNo,Description,Total
	from Clins
	where Id_ara=#id_ara#
</cfquery>
<cfset ClinList="
CLIN(s):<br><br>
">
<cfoutput query="getClins">
	<cfset ClinList="#ClinList#" & "
	#ClinNo# - #Description# #Dollarformat(Total)#<br>
	">
</cfoutput>
<cfset ClinList="#ClinList#" & "
...
<cfquery name="CCS" datasource="#Application.dsn#">
	Select oprid,email from users
	where id_job=13
	and Inactive=0
</cfquery>
<cfset to="">
<cfoutput query="CCS">
	<cfset to=ListAppend(To,"#email")>
</cfoutput>
<cfoutput>
<cfset MsgDist="
         ...
         <table width='560' border='0' bgcolor='##4b5c63' cellspacing='0' cellpadding='0'>
            <tr>
               <td bgcolor='##7995a2' colspan='3'>
				  ...
				  <p class='tag'>Early Start Complete.</p>
                              ...
                              <tr>
                                 <td class='detail'><br><br>
								   ...
								   <tr>
									...
									<tr bgcolor='##000000'>
									<td  valign='top' class='border'>New CLINS</td><td  valign='top' class='border'>#ClinList#</td>
