...
<cfset subject="ARA #reference#: Rejected by #session.empname#.">
<cfset intro="ARA rejected and returned to Program Manager">
<cfoutput>
                              ...
                              <tr>
                                 <td class='detail'><br><br>
                                   <table bgcolor='##596c74' align='center' cellpadding='4' cellspacing='2' class='border'>
									...
									<tr bgcolor='black'>
								   	<td valign='top' class='border'>Rejection Reason</td><td valign='top' class='border'>#gReason.reason#</td>
									</tr>
									<tr bgcolor='black'>
								   	<td valign='top' class='border'>Rejection Comments</td><td valign='top' class='border'>#form.Rej_desc#</td>
									</tr>
									<tr bgcolor='black'>
								   	<td valign='top' class='border'>Correct Sections:</td><td valign='top' class='border'>#Rej_areas#</td>
									</tr>
								   <tr>
